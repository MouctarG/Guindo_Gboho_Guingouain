...
public class StorageUtils {
    ...
    /**
     * Explications :  Nous avons ajouté ici plusieurs méthodes.
     * Les deux dernières permettent de vérifier si l'espace de stockage externe
     * est bien disponible et si l'on peut lire (isExternalStorageReadable )
     * ou écrire (isExternalStorageWritable ) dessus.
     * <p>
     * Puis nous avons créé deux autres méthodes permettant d'écrire et lire
     * du texte dans un fichier se trouvant dans un espace de stockage défini en paramètre...
     * en réutilisant les méthodes   writeOnFile  et  createOrGetFile  que nous avons créées
     * précédemment
     *
